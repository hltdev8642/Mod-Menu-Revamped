...
locLangLookup = {
	...
	exitBatchSelect = {
		"Exit Batch Select",
		"Quitter la sélection par lot",
		"Salir de selección por lotes",
		"Esci dalla selezione batch",
		"Stapel-Auswahl beenden",
		"退出批量选择",
		"一括選択を終了",
		"Выйти из пакетного выбора",
		"Wyjdź z wyboru wsadowego",
	},
